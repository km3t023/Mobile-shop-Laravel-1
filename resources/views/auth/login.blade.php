...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div style="font-family:Spectral;" class="card-header">{{ __('Uloguj se') }}</div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" style="font-family:Spectral;" for="remember">
                                        <b>{{ __('Zapamti me') }}</b>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                @if (Route::has('password.request'))
                                    <a class="btn btn-warning" style="font-family:Spectral;" href="{{ route('password.request') }}" class="text-dark">
